    ...
    <div class="content container-fluid">
        ...
        <ul class="nav nav-tabs menu-tabs">
            <li class="nav-item active">
                <a class="nav-link" href="<c:url value="/admin/list-order"/>">Total order<span class="badge badge-primary">${totalOrder}</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<c:url value="/admin/list-pendingOrder"/>">Pending<span class="badge badge-primary">${countPendingOrders}</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<c:url value="/admin/list-shippingOrder"/>">Shipping<span class="badge badge-primary">${countShippingOrders}</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<c:url value="/admin/list-deliveredOrder"/>">Delivered<span class="badge badge-primary">${countDeliveredOrders}</span></a>
            </li>
        </ul>
        <!-- Search Filter -->
                            ...
                            <table class="table table-center">
                                ...
                                <c:forEach items="${orderList}" var="orders">
                                    <tr>
                                        ...
                                        <form action="<c:url value='/admin/delivery-order/${orders.id}'/>" method="post">
                                            <td class="text-right">
                                                <input type="hidden" value="${orders.id}">
                                                <button class="confirm-btn" type="submit">
                                                    <i class="fas fa-shipping-fast"></i></i>Delivery
                                                </button>
                                            </td>
                                        </form>
                                    </tr>
