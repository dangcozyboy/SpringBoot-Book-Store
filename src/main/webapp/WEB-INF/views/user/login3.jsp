...
<body>
<div class="u-header-sidebar__footer-offset" style="width: 500px;; margin: auto;">
    <!-- Toggle Button -->
                    ...
                    <div class="p-4 p-md-6">
                        ...
                        <form method="POST" action="/j_spring_security_check">
                            ...
                            <div class="form-group mb-4">
                                <label id="signinEmailLabel9" class="form-label" for="signinEmail9">Username or email
                                    *</label>
                        ...
                        <div class="form-group mb-4">
                            <div class="js-form-message js-focus-state">
                                ...
                                <input type="email" class="form-control rounded-0 height-4 px-4" name="email"
                                       id="signinEmail11" placeholder="creativelayers088@gmail.com"
                                       aria-label="creativelayers088@gmail.com" aria-describedby="signinEmailLabel11"
                                       required>
                            </div>
                        </div>
                        <!-- End Form Group -->
                        ...
                        <div class="form-group mb-4">
                            <div class="js-form-message js-focus-state">
                                <label id="signinPasswordLabel11" class="form-label" for="signinPassword11">Password
                                    *</label>
                                <input type="password" class="form-control rounded-0 height-4 px-4" name="password"
                                       id="signinPassword11" placeholder="" aria-label=""
                        ...
                        <div class="form-group mb-4">
                            <div class="js-form-message js-focus-state">
                                ...
                                <input type="password" class="form-control rounded-0 height-4 px-4"
                                       name="confirmPassword" id="signupConfirmPassword9" placeholder="" aria-label=""
                    ...
                    <div class="p-4 p-md-6">
                        ...
                        <div class="form-group mb-4">
                            <div class="js-form-message js-focus-state">
                                ...
                                <input type="email" class="form-control rounded-0 height-4 px-4" name="email"
                                       id="signinEmail33" placeholder="creativelayers088@gmail.com"
                                       aria-label="creativelayers088@gmail.com" aria-describedby="signinEmailLabel33"
                                       required>
                            </div>
                        </div>
                        <!-- End Form Group -->
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-block py-3 rounded-0 btn-dark">Recover Password
                            </button>
                        </div>
