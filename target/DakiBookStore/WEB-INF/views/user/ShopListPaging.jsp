            ...
            <div id="primary" class="content-area order-2" style="width: 60%; margin-left: 24px">
                <div class="shop-control-bar d-lg-flex justify-content-between align-items-center mb-5 text-center text-md-left">
                    <div class="shop-control-bar__left mb-4 m-lg-0">
                        <p class="woocommerce-result-count m-0">Showing 1–12 of ${countBook}</p>
                    </div>
                                            ...
                                            <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                                                ...
                                                <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                                    ...
                                                    <div class="price d-flex align-items-center font-weight-medium font-size-3">
                                                        <span class="woocommerce-Price-amount amount"><span
                                                                class="woocommerce-Price-currencySymbol">VND</span>${books.price}</span>
                                                    </div>
                                                </div>
                                                <div class="product__hover d-flex align-items-center">
                                                    <div class="product__hover d-flex align-items-center">
                                                            ...
                                                            <%--                                                        <input type="hidden" name="id" <c:out value='${books.id}'/>--%>
                                                            <%--&lt;%&ndash;                                                        <input type="submit" class="product__add-to-cart" value="ADD TO CART">&ndash;%&gt;--%>
                ...
                <div id="widgetAccordion">
                    ...
                    <div id="Authors" class="widget widget_search widget_author p-4d875 border">
                        ...
                        <div id="widgetCollapse21" class="mt-4 widget-content collapse show"
                            ...
                            <ul class="product-categories">
                                <c:forEach items="${List_author}" var="author">
                                    <li class="cat-item cat-item-9 cat-parent">
                                        <a href="../others/authors-single.html">${author.name}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
